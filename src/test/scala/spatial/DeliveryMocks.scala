...
object DeliveryMocks:
  ...
  val testHubAddress: Long = java.lang.Long.valueOf ("8f39601ae658180", 16)
  val locationsInTree: Seq [H3] = (1 to 10).map (_ => h3RandomInHex (testHubAddress, testTreeLevel))

  // NOTE - these are generated to be outside any sensible tree containing testHubAddress
  val josZoo: Long = hex.instance.latLngToCell (9.920420123563392, 8.887754970466519, 15)
